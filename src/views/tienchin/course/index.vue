<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程编号" align="center" prop="courseId" width="80" :show-overflow-tooltip="true"/>
      <el-table-column label="课程名称" align="center" prop="courseName" width="120" :show-overflow-tooltip="true"/>
      <el-table-column label="课程类型" align="center" prop="type" width="120" :show-overflow-tooltip="true">
        <template #default="scope">
          <dict-tag :options="course_type" :value="scope.row.type"/>
        </template>
      </el-table-column>
      <el-table-column label="课程价格" align="center" prop="price" width="120" :show-overflow-tooltip="true"/>
      <el-table-column label="适用人群" align="center" prop="info" width="120" :show-overflow-tooltip="true">
        <template #default="scope">
          <dict-tag :options="course_apply" :value="scope.row.apply"/>
        </template>
      </el-table-column>
      <el-table-column label="课程简介" align="center" prop="info" width="280" :show-overflow-tooltip="true"/>
      <el-table-column label="备注" align="center" prop="remark" width="280" :show-overflow-tooltip="true"/>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="courseRef" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="课程名称" prop="courseName">
              <el-input v-model="form.courseName" placeholder="请输入活动名"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="课程类型" prop="type">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="课程价格" prop="courseName">
          ...
          <el-col :span="12">
            <el-form-item label="适用人群" prop="apply">
              <el-select v-model="form.apply"
                         ...
                         style="width: 240px">
                <el-option
                    v-for="apply in course_apply"
                    :key="apply.value"
                    :label="apply.label"
                    :value="parseInt(apply.value)"
                />
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-form-item label="课程简介" prop="info">
          <el-input v-model="form.info" placeholder="请输入课程简介"></el-input>
        </el-form-item>
...
const {
  course_apply,
  course_type
} = proxy.useDict("course_apply", "course_type");
...
const data = reactive({
  ...
  rules: {
    courseName: [{required: true, message: "活动名称不能为空", trigger: "blur"}],
    price: [{required: true, message: "活动名称不能为空", trigger: "blur"}],
    apply: [{required: true, message: "活动名称不能为空", trigger: "blur"}],
