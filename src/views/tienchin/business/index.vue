<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
            ...
            icon="Plus"
            @click="handleAdd"
            v-hasPermi="['tienchin:business:add']"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="businessList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商机状态" align="center" prop="status" width="120" :show-overflow-tooltip="true">
      ...
      <el-table-column label="商机归属人" align="center" prop="owner" width="120" :show-overflow-tooltip="true"/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          ...
          <el-button link v-if="scope.row.owner == userStore.name &&(scope.row.status == 1 || scope.row.status == 2)"
                     ...
                     v-hasPermi="['tienchin:business:follow']">跟进
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    />
    <!-- 分配商机对话框 -->
    <el-dialog title="分配商机" v-model="assignBusinessOpen" width="600px" append-to-body>
      <el-form ref="assignBusinessRef" :model="assignForm" :rules="assignRules" label-width="80px">
        <el-row>
          <el-col :span="12">
...
const {sys_user_sex, clue_status, business_status} = proxy.useDict("sys_user_sex", "clue_status", "business_status");
...
/** 分配按钮操作 */
function handleBusinessAssign(row) {
  // 显示对话框
  assignBusinessOpen.value = true;
  // 初始化部门信息
  assignForm.value.assignId = row.businessId
  initTreeData();
}
